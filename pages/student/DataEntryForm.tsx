    ...
    return (
      <div className="min-h-screen bg-gray-100 py-20 flex flex-col items-center animate-fadeIn">
        <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-4 border-kku-blue max-w-2xl w-full text-center">
          ...
          <button onClick={() => navigate('/')} className="text-gray-400 font-black uppercase text-[10px] tracking-widest hover:text-kku-blue transition-colors underline">Return to Home Page</button>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-white shadow-2xl border-[1.5mm] border-[#001F3F] p-[10mm] w-[210mm] min-h-[297mm] box-border relative">
        ...
        <div className="flex items-center justify-between mb-2">
           ...
           <div className="text-right flex flex-col items-end">
              <button onClick={() => navigate('/')} className="bg-kku-blue text-white px-4 py-1 text-[8pt] font-black uppercase tracking-widest mb-1 shadow-md border border-kku-blue/10 hover:bg-red-700 transition-all">Return to Home Page</button>
